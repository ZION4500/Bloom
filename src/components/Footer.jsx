export default function Footer() {
    ...
    return (
        <footer className="bg-[#D9D9D9] text-black font-sans p-5 flex md:flex-row flex-col justify-around dark:bg-[#000634] ">
            <ul className="w-80">
            ...
            <div className="flex md:justify-around md:mt-0 mt-5 justify-between w-full">
                <ul>
