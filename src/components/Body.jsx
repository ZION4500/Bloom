...
export default function Body() {
    return (
        <main className="mr-auto ml-auto  m-20 ">
            <div className=' text-white font-sans p-5 m-20'>
                <img src={floral} alt="" />
                <div className=' absolute bg-white shadow-2xl  w-[25rem] h-60 z-10 top-[470px] left-[180px] rounded-lg dark:bg-[#060F2E]'>
