        ...
        <header className='bg-[#3D7993] text-white font-sans p-5 dark:bg-[#042B50] w-full'>
            <nav>
                <ul className='flex md:justify-around justify-between '>
                    <li className='text-4xl text-[#77BEB1] md:pr-5'><a href="/">Bloom</a></li>
                    <li className=' md:my-auto md:text-right md:text-2xl  hidden'><a href="/">Home</a></li>
                    ...
                    <div className="dropdown inline-block relative">
                        ...
                        <li className=""><a className="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="/">Home</a></li>
